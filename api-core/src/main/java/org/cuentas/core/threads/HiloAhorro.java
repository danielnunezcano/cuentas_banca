...
public class HiloAhorro implements Callable<List<CuentaDto>> {
	
	private final CuentasRepository cuentasRepository;

	@Override
	public List<CuentaDto> call() throws Exception {
		return CuentaMapper.INSTANCE.cuentaToCuentaDtos(this.cuentasRepository.findByType(TypeAccount.AHORRO.name()));
	}
